  ...
  if (entry.entryType === 'unterhalt') {
    div.innerHTML = `
      <div class="entry-header">
        ...
        <div class="entry-header-amount unterhalt-amount">${formatInvoiceAmount(entry.betrag)}</div>
    ...
    div.innerHTML = `
      <div class="entry-header">
        ...
        <div class="entry-header-amount ofen-amount">${formatInvoiceAmount(totalAmount)}</div>
