  ...
  if (entry.entryType === 'unterhalt') {
    div.innerHTML = `
      <div class="entry-header">
        ...
        <div class="entry-header-amount">${formatInvoiceAmount(entry.betrag)} (Ausgabe)</div>
    ...
    div.innerHTML = `
      <div class="entry-header">
        ...
        <div class="entry-header-amount">${formatInvoiceAmount(totalAmount)} (Gesamtbetrag)</div>
